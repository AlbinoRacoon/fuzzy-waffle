...
colorAdminApp.config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
  ...
  $stateProvider
    ...
    .state('app.ai.chat', {
      ...
      templateUrl: 'views/ai_chat.html',
      resolve: {
        service: ['$ocLazyLoad', function ($ocLazyLoad) {
          return $ocLazyLoad.load({
          	serie: true,
    ...
    .state('app.ai.imageGenerator', {
      url: '/image-generator',
      data: {
        pageTitle: 'AI Image Generator'
      },
      templateUrl: 'views/ai_image_generator.html',
      resolve: {
        service: ['$ocLazyLoad', function ($ocLazyLoad) {
          return $ocLazyLoad.load({
          	serie: true,
        ...
        service: ['$ocLazyLoad', function ($ocLazyLoad) {
          return $ocLazyLoad.load({
            ...
            files: [
            	...
            	'../assets/plugins/quill/dist/quill.snow.css',
              '../assets/plugins/quill/dist/quill.js',
          ...
          return $ocLazyLoad.load({
            ...
            files: [
              '../assets/plugins/datatables.net-bs5/css/dataTables.bootstrap5.min.css',
							...
							'../assets/plugins/datatables.net/js/dataTables.min.js',
