...
Website: http://www.seantheme.com/color-admin/
	...
	101.0 CONTROLLER - Landing Page
	
	102.0 CONTROLLER - AI Chat
	103.0 CONTROLLER - AI Image Generator
...
colorAdminApp.controller('appController', ['$rootScope', '$scope', function ($rootScope, $scope) {
  ...
  $scope.$on('$stateChangeStart', function () {
    ...
    $('.dtfh-floatingparent, .daterangepicker, .jvectormap-tip, .ui-helper-hidden-accessible, .ui-autocomplete, .dz-hidden-input').remove();
  });
...
/* -------------------------------
   101.0 CONTROLLER - Landing Page
------------------------------- */
colorAdminApp.controller('landingController', function ($scope, $rootScope, $state) {
  $rootScope.setting.layout.appHeaderNone = true;
  $rootScope.setting.layout.appSidebarNone = true;
  $rootScope.setting.layout.paceTop = true;
  $rootScope.setting.layout.appContentClass = 'p-0';
...
/* -------------------------------
   102.0 CONTROLLER - AI Chat
------------------------------- */
colorAdminApp.controller('aiChatController', function ($scope, $rootScope, $state) {
  $rootScope.setting.layout.appContentClass = 'p-0 bg-body';
  $rootScope.setting.layout.appContentFullHeight = true;

  angular.element(document).ready(function () {
    $.getScript('../assets/js/demo/ai-chat.demo.js');
  });
});
...
/* -------------------------------
   103.0 CONTROLLER - AI Image Generator
------------------------------- */
colorAdminApp.controller('aiImageGeneratorController', function ($scope, $rootScope, $state) {
  angular.element(document).ready(function () {
    $.getScript('../assets/js/demo/ai-image-generator.demo.js');
  });
});