...
<a href="#/" aria-label="Fullscreen" on:click={fullscreenToggler} data-bs-toggle="tooltip" data-bs-title="Expand / Compress" data-bs-placement="bottom" data-bs-container="body" class="text-white text-opacity-50 text-decoration-none">
