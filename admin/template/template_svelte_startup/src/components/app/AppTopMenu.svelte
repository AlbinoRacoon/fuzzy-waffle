<script>
  ...
  function handleUnlimitedTopMenuRender() {
		...
		function handleMenuButtonAction(element, direction) {
			...
			switch (direction) {
				case 'next':
					...
					break;
				case 'prev':
					var widthLeft2 = -marginLeft;
	
					if (widthLeft2 <= containerWidth) {
						obj.querySelector('.menu-control.menu-control-start').classList.remove('show');
						finalScrollWidth = 0;
					} else {
						finalScrollWidth = widthLeft2 - containerWidth + controlWidth;
					}
		...
		var elm2 = document.querySelector('[data-toggle="app-top-menu-prev"]');
		if (elm2) {
...
<div id="top-menu" class="app-top-menu" data-bs-theme="dark">
	<div class="menu">
		...
		<div class="menu-item menu-control menu-control-start">
			<a href="#/" aria-label="Top Menu Prev Toggler" class="menu-link" data-toggle="app-top-menu-prev"><i class="fa fa-angle-left"></i></a>
		</div>
		<div class="menu-item menu-control menu-control-end">
			<a href="#/" aria-label="Top Menu Next Toggler" class="menu-link" data-toggle="app-top-menu-next"><i class="fa fa-angle-right"></i></a>
		</div>
	</div>
</div>