<script>
  ...
  function toggleRtlEnabled() {
		$appOptions.appRtlEnabled = !$appOptions.appRtlEnabled;
	
		if ($appOptions.appRtlEnabled) {
			document.documentElement.setAttribute('dir', 'rtl');
		} else {
			document.documentElement.removeAttribute('dir');
		}
	
		localStorage.setItem('app-rtl-enabled', $appOptions.appRtlEnabled);
	}
  ...
  function showDjangoAlert() {
	...
	onMount(async () => {
		...
		if (typeof localStorage !== 'undefined') {
			...
			if (localStorage.getItem('app-rtl-enabled')) {
				$appOptions.appRtlEnabled = JSON.parse(localStorage.getItem('app-rtl-enabled'));
				if ($appOptions.appRtlEnabled) {
					document.documentElement.setAttribute('dir', 'rtl');
				}
			}
...
<div class="theme-panel" class:active={ active === 'true' }>
	<a href="#/" on:click={themePanelToggler} class="theme-collapse-btn"  aria-label="Toggler"><i class="fa fa-cog"></i></a>
	<PerfectScrollbar class="theme-panel-content h-100">
		...
		<div class="theme-list">
			{#each themeList as theme}
				<div class="theme-list-item" class:active={theme.themeClass == activeTheme}>
					<a href="#/" class="theme-list-link {theme.bgClass}"  aria-label="Theme Toggler" on:click|preventDefault={() => themeColorToggler(theme.themeClass)} data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-container="body" data-bs-title="{theme.name}">&nbsp;</a>
				</div>
			{/each}
		</div>
		...
		<div class="row mt-10px align-items-center">
			<div class="col-md-8 control-label text-dark fw-bold d-flex">RTL Enabled <span class="badge bg-primary ms-1 position-relative d-flex align-items-center">NEW</span></div>
			<div class="col-md-4 d-flex">
				<div class="form-check form-switch ms-auto mb-0">
					<input type="checkbox" class="form-check-input" id="appRtlEnabled" on:click={toggleRtlEnabled} checked={$appOptions.appRtlEnabled} />
		...
		<div class="theme-version">
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/admin/html/index_v3.html" aria-label="Default" class="theme-version-link active">
					<span style="background-image: url(/img/theme/default.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/admin/transparent/index_v3.html" aria-label="Transparent" class="theme-version-link">
					<span style="background-image: url(/img/theme/transparent.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/admin/apple/index_v3.html" aria-label="Apple" class="theme-version-link">
					<span style="background-image: url(/img/theme/apple.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/admin/material/index_v3.html" aria-label="Material" class="theme-version-link">
					<span style="background-image: url(/img/theme/material.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/admin/facebook/index_v3.html" aria-label="Facebook" class="theme-version-link">
					<span style="background-image: url(/img/theme/facebook.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/admin/google/index_v3.html" aria-label="Google" class="theme-version-link">
		...
		<div class="theme-version">
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/admin/html/index_v3.html" aria-label="HTML" class="theme-version-link">
					<span style="background-image: url(/img/version/html.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/admin/ajax/"  aria-label="Ajax" class="theme-version-link">
					<span style="background-image: url(/img/version/ajax.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/admin/angularjs/" aria-label="Angular 1.x" class="theme-version-link">
					<span style="background-image: url(/img/version/angular1x.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/admin/angularjs20/" aria-label="Angular 18.x" class="theme-version-link">
					<span style="background-image: url(/img/version/angular20x.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/admin/svelte/" aria-label="Svelte" class="theme-version-link active">
					<span style="background-image: url(/img/version/svelte.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="#/" on:click|preventDefault={showLaravelAlert}  aria-label="Laravel" class="theme-version-link">
					<span style="background-image: url(/img/version/laravel.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="#/" on:click|preventDefault={showDjangoAlert} aria-label="Django" class="theme-version-link">
					<span style="background-image: url(/img/version/django.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/admin/vue3/" aria-label="Vue 3" class="theme-version-link">
					<span style="background-image: url(/img/version/vuejs.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/admin/react/" aria-label="React 18" class="theme-version-link">
					<span style="background-image: url(/img/version/reactjs.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="#/" on:click|preventDefault={showDotnetAlert} aria-label="Dotnet" class="theme-version-link">
					<span style="background-image: url(/img/version/dotnet.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/admin/nextjs/" aria-label="Vue 3" class="theme-version-link">
					<span style="background-image: url(/img/version/nextjs.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
		</div>
		...
		<div class="theme-version">
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/frontend/one-page-parallax/" aria-label="One Page Parallax" target="_blank" class="theme-version-link">
					<span style="background-image: url(/img/theme/one-page-parallax.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/frontend/e-commerce/" aria-label="E-Commerce" target="_blank" class="theme-version-link">
					<span style="background-image: url(/img/theme/e-commerce.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/frontend/blog/" aria-label="Blog" target="_blank" class="theme-version-link">
					<span style="background-image: url(/img/theme/blog.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/frontend/forum/" aria-label="Forum" target="_blank" class="theme-version-link">
					<span style="background-image: url(/img/theme/forum.jpg);" class="theme-version-cover"></span>
				</a>
			</div>
			<div class="theme-version-item">
				<a href="https://seantheme.com/color-admin/frontend/corporate/" aria-label="Corporate" target="_blank" class="theme-version-link">
