<script>
  ...
  onMount(async () => {
    setPageTitle('Page with Top Menu');
    
		let response = await fetch('/data/page-option/with-top-menu-code-1.json');
...
<Panel class="panel-inverse">
	...
	<PanelBody>
		<p>
			Add the following code for page with top menu setting.
		</p>
	</PanelBody>
	{#if code1}
