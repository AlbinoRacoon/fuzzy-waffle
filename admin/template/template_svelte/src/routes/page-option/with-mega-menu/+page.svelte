<script>
  ...
  onMount(async () => {
    setPageTitle('Page with Mega Menu');
    
		let response = await fetch('/data/page-option/with-mega-menu-code-1.json');
...
<Panel class="panel-inverse">
	...
	<PanelBody>
		<p>
			Add the following code for page with mega menu setting.
		</p>
	</PanelBody>
	{#if code1}
