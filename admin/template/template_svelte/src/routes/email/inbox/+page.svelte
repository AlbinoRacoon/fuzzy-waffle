			...
			<div class="btn-toolbar align-items-center">
				...
				<div class="dropdown me-2">
					...
					<div class="dropdown-menu">
						<a href="#/" class="dropdown-item"><i class="fa fa-circle fs-9px fa-fw me-2"></i> All</a>
						<a href="#/" class="dropdown-item"><i class="fa fa-circle fs-9px fa-fw me-2 text-muted"></i> Unread</a>
						<a href="#/" class="dropdown-item"><i class="fa fa-circle fs-9px fa-fw me-2 text-blue"></i> Contacts</a>
						<a href="#/" class="dropdown-item"><i class="fa fa-circle fs-9px fa-fw me-2 text-success"></i> Groups</a>
						<a href="#/" class="dropdown-item"><i class="fa fa-circle fs-9px fa-fw me-2 text-warning"></i> Newsletters</a>
						<a href="#/" class="dropdown-item"><i class="fa fa-circle fs-9px fa-fw me-2 text-danger"></i> Social updates</a>
						<a href="#/" class="dropdown-item"><i class="fa fa-circle fs-9px fa-fw me-2 text-indigo"></i> Everything else</a>
					</div>
				</div>
				<button class="btn btn-sm btn-white me-2" aria-label="Example"><i class="fa fa-redo"></i></button>
				...
				<div class="btn-group ms-auto">
					<button class="btn btn-white btn-sm" aria-label="Example">
			...
			<PerfectScrollbar class="h-100">
				<ul class="list-group list-group-lg no-radius list-email">
					...
					<li class="list-group-item">
						...
						<a href="/email/detail" class="email-user bg-grey" aria-label="Example">
					...
					<li class="list-group-item">
						...
						<a href="/email/detail" class="email-user">
							<img src="/img/user/user-14.jpg" alt="" />
						</a>
						<div class="email-info">
							<a href="/email/detail">
