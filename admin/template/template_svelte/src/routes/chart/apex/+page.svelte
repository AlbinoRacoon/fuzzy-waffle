<script>
  ...
  import { appVariables } from '/src/stores/appVariables.js';
		...
		return {
			options: {
				...
				dataLabels: {
					enabled: true,
					offsetX: -6,
					style: { fontSize: '12px', colors: [appVariables.color.dark] }
				},
				colors: [appVariables.color.warning, appVariables.color.gray500],
				stroke: { show: false },
				xaxis: {
					...
					axisTicks: { show: true, borderType: 'solid', color: appVariables.color.gray300,	height: 6, offsetX: 0, offsetY: 0 }
				}
			}
		};
	}
	...
	function getChart5Data(appVariables) {
		return {
			options: {
				...
				stroke: { width: [0, 0, 3] },
				colors: [appVariables.color.primary, appVariables.color.teal, appVariables.color.warning],
				title: {
				...
				yaxis: [{
					axisTicks: { show: true, color: appVariables.color.borderColor },
					axisBorder: { show: true, color: appVariables.color.borderColor },
					labels: { style: { colors: [appVariables.color.bodyColor] } },
					title: {
						text: "Income (thousand crores)",
						style: { color: appVariables.color.bodyColor }
					},
	...
	function getChart6Data(appVariables) {
		return {
			options: {
				...
				xaxis: {
					type: 'datetime',
					axisBorder: { show: true, color: appVariables.color.gray300, height: 1, width: '100%', offsetX: 0, offsetY: -1 },
					axisTicks: { show: true, borderType: 'solid', color: appVariables.color.gray300, height: 6, offsetX: 0, offsetY: 0 }
				},
	...
	function getChart7Data(appVariables) {
		return {
			options: {
				chart: { height: 350, type: 'bubble' },
				series: [
					{ name: 'Bubble1', data: generateBubbleChartData(new Date('11 Feb 2022 GMT').getTime(), 20, { min: 10, max: 60 }) },
					{ name: 'Bubble2', data: generateBubbleChartData(new Date('11 Feb 2022 GMT').getTime(), 20, { min: 10, max: 60 }) },
					{ name: 'Bubble3', data: generateBubbleChartData(new Date('11 Feb 2022 GMT').getTime(), 20, { min: 10, max: 60 }) },
					{ name: 'Bubble4', data: generateBubbleChartData(new Date('11 Feb 2022 GMT').getTime(), 20, { min: 10, max: 60 }) }
				],
				dataLabels: { enabled: false },
				colors: [appVariables.color.primary, appVariables.color.warning, 'rgba('+ appVariables.color.darkRgb + ', .5)', appVariables.color.pink],
				fill: { opacity: 0.8 },
	...
	function getChart8Data(appVariables) {
		return {
			options: {
				chart: {
					height: 350,
				...
				colors: [appVariables.color.primary, appVariables.color.warning, 'rgba('+ appVariables.color.darkRgb + ', .5)'],
				xaxis: {
					tickAmount: 10,
					labels: {
	...
	function getChart9Data(appVariables) {
		return {
			options: {
	...
	function getChart10Data(appVariables) {
		return {
			options: {
	...
	function getChart11Data(appVariables) {
		return {
			options: {
	...
	function getChart12Data(appVariables) {
		return {
			options: {
	...
	onMount(async () => {
		setPageTitle('Apexcharts.js');
	
		for (var i = 1; i < 13; i++) {
			let response = await fetch('/data/chart/apexchart-code-'+ i +'.json');
		...
		unsubscribe = appVariables.subscribe(value => {
			if (value.color) {
				...
				chartArray[7] = getChart7Data(value);
				chartArray[8] = getChart8Data(value);
				chartArray[9] = getChart9Data(value);
				chartArray[10] = getChart10Data(value);
				chartArray[11] = getChart11Data(value);
				chartArray[12] = getChart12Data(value);
			}
		});
	});
...
<div class="row">
	<div class="col-xl-6">
		<Panel class="panel-inverse">
			...
			<PanelBody class="p-0 pe-10px">
				{#if chartArray[1]}
					<ApexCharts options={chartArray[1].options}></ApexCharts>
				{/if}
			</PanelBody>
			{#if codeArray[1]}
	...
	<div class="col-xl-6">
		<Panel class="panel-inverse">
			<PanelHeader>
				<PanelTitle>Column Chart</PanelTitle>
				<PanelExpandToggler />
			</PanelHeader>
			<PanelBody>
				<p class="mb-0">
			...
			<PanelBody class="p-0 ps-10px pe-10px">
				{#if chartArray[2]}
					<ApexCharts options={chartArray[2].options}></ApexCharts>
				{/if}
			</PanelBody>
			{#if codeArray[2]}
	...
	<div class="col-xl-6">
		<Panel class="panel-inverse">
			<PanelHeader>
				<PanelTitle>Area Chart</PanelTitle>
				<PanelExpandToggler />
			</PanelHeader>
			<PanelBody>
				<p class="mb-0">
			...
			<PanelBody class="p-0 pe-10px">
				{#if chartArray[3]}
					<ApexCharts options={chartArray[3].options}></ApexCharts>
				{/if}
			</PanelBody>
			{#if codeArray[3]}
	...
	<div class="col-xl-6">
		<Panel class="panel-inverse">
			...
			<PanelBody class="p-0 ps-5px pe-10px">
				{#if chartArray[4]}
					<ApexCharts options={chartArray[4].options}></ApexCharts>
				{/if}
			</PanelBody>
			{#if codeArray[4]}
	...
	<div class="col-xl-6">
		<Panel class="panel-inverse">
			<PanelHeader>
				<PanelTitle>Mixed Chart</PanelTitle>
				<PanelExpandToggler />
			</PanelHeader>
			<PanelBody>
				<p class="mb-0">
			...
			<PanelBody class="p-0 pe-10px">
				{#if chartArray[5]}
					<ApexCharts options={chartArray[5].options}></ApexCharts>
				{/if}
			</PanelBody>
			{#if codeArray[5]}
	...
	<div class="col-xl-6">
		<Panel class="panel-inverse">
			<PanelHeader>
				<PanelTitle>Candlestick Chart</PanelTitle>
				<PanelExpandToggler />
			</PanelHeader>
			<PanelBody>
				<p class="mb-0">
			...
			<PanelBody class="p-0 ps-5px pe-10px">
				{#if chartArray[6]}
					<ApexCharts options={chartArray[6].options}></ApexCharts>
				{/if}
			</PanelBody>
			{#if codeArray[6]}
	...
	<div class="col-xl-6">
		<Panel class="panel-inverse">
			<PanelHeader>
				<PanelTitle>Bubble Chart</PanelTitle>
				<PanelExpandToggler />
			</PanelHeader>
			<PanelBody>
				<p class="mb-0">
			...
			<PanelBody class="p-0 ps-5px pe-10px">
				{#if chartArray[7]}
					<ApexCharts options={chartArray[7].options}></ApexCharts>
				{/if}
			</PanelBody>
			{#if codeArray[7]}
	...
	<div class="col-xl-6">
		<Panel class="panel-inverse">
			<PanelHeader>
				<PanelTitle>Scatter Chart</PanelTitle>
				<PanelExpandToggler />
			</PanelHeader>
			<PanelBody>
				<p class="mb-0">
			...
			<PanelBody class="p-0 ps-5px pe-10px">
				{#if chartArray[8]}
					<ApexCharts options={chartArray[8].options}></ApexCharts>
				{/if}
			</PanelBody>
			{#if codeArray[8]}
	...
	<div class="col-xl-6">
		<Panel class="panel-inverse">
			<PanelHeader>
				<PanelTitle>Heatmap Chart</PanelTitle>
				<PanelExpandToggler />
			</PanelHeader>
			<PanelBody>
				<p class="mb-0">
			...
			<PanelBody class="p-0 ps-5px pe-10px">
				{#if chartArray[9]}
					<ApexCharts options={chartArray[9].options}></ApexCharts>
				{/if}
			</PanelBody>
			{#if codeArray[9]}
	...
	<div class="col-xl-6">
		<Panel class="panel-inverse">
			...
			<PanelBody class="p-0 ps-5px pe-10px">
				{#if chartArray[10]}
					<ApexCharts options={chartArray[10].options}></ApexCharts>
				{/if}
			</PanelBody>
			{#if codeArray[10]}
	...
	<div class="col-xl-6">
		<Panel class="panel-inverse">
			<PanelHeader>
				<PanelTitle>Radial Bar Chart</PanelTitle>
				<PanelExpandToggler />
			</PanelHeader>
			<PanelBody>
				<p class="mb-0">
			...
			<PanelBody class="p-0">
				{#if chartArray[11]}
					<ApexCharts options={chartArray[11].options}></ApexCharts>
				{/if}
			</PanelBody>
			{#if codeArray[11]}
	...
	<div class="col-xl-6">
		<Panel class="panel-inverse">
			...
			<PanelBody class="p-0">
				{#if chartArray[12]}
					<ApexCharts options={chartArray[12].options}></ApexCharts>
				{/if}
			</PanelBody>
			{#if codeArray[12]}
				<HighlightJs code={codeArray[12]} />
			{/if}
		</Panel>
	</div>
</div>