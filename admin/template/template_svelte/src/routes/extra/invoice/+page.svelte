...
<div class="invoice">
	<div class="invoice-company">
		<span class="float-end hidden-print">
			<a href="#/" class="btn btn-sm btn-white mb-10px"><i class="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i> Export as PDF</a>
			<a href="#/" on:click|preventDefault={() => window.print()} class="btn btn-sm btn-white mb-10px"><i class="fa fa-print t-plus-1 fa-fw fa-lg"></i> Print</a>
		</span>
		Company Name, Inc
	</div>
