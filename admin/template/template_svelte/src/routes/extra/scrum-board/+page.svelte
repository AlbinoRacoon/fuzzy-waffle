<script>
  ...
  let tags = ['enhancement'];
  
  onMount(async () => {
    setPageTitle('Scrumb Board');
...
<div class="app-content-padding" style="min-height: 100vh; background: url(/img/cover/cover-scrum-board.png) no-repeat fixed; background-size: 360px; background-position: right bottom;">
	...
	<div class="row">
					...
					<a href="#/" class="list-group-item d-flex">
						...
						<div class="flex-fill">
							...
							<div class="mb-1 d-flex align-items-center">
								...
								<div class="d-flex">
									<div class="widget-img widget-img-xs rounded-circle bg-dark me-n2" style="background-image: url(/img/user/user-1.jpg)">
									</div>
									<div class="widget-img widget-img-xs rounded-circle bg-dark me-n2" style="background-image: url(/img/user/user-2.jpg)">
									</div>
									<div class="widget-img widget-img-xs rounded-circle bg-dark me-n2" style="background-image: url(/img/user/user-3.jpg)">
									</div>
		...
		<div class="col-xl-4 col-lg-6">
			<Panel class="panel-inverse">
				<PanelHeader>
					<PanelTitle>In Progress (2)</PanelTitle>
					<PanelExpandToggler />
				</PanelHeader>
				<div class="list-group list-group-flush rounded-bottom overflow-hidden panel-body p-0">
					<div class="list-group-item d-flex border-top-0">
					...
					<div class="list-group-item d-flex">
						...
						<div class="flex-fill">
							...
							<div class="mb-1">
								<span class="badge bg-gray-300 text-gray-900">issue</span>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="mb-3">
					<label class="form-label" for="enhancement">Title</label>
					<input type="text" class="form-control" id="enhancement" placeholder="e.g Feature enhancement" />
				</div>
				<div class="mb-3">
