<script>
  ...
  onMount(async () => {
    ...
    $appOptions.appContentClass = 'p-0 bg-component';
	...
	<div class="row gx-2 pb-10px">
		<div class="col-lg-4">
			<div class="position-relative">
				...
				<button class="btn position-absolute start-0 top-0 shadow-none" aria-label="Button"><i class="fa fa-search fa-lg"></i></button>
			</div>
		</div>
