...
<Panel class="panel-inverse flex-1 m-0 d-flex flex-column overflow-hidden">
	<PanelHeader>
		<PanelTitle>File Manager</PanelTitle>
		<PanelExpandToggler />
	</PanelHeader>
	<PanelBody class="p-0 flex-1 overflow-hidden">
		<div class="file-manager h-100" class:file-manager-sidebar-mobile-toggled={mobileSidebarToggled}>
			...
			<div class="file-manager-container">
				<div class="file-manager-sidebar">
					<div class="file-manager-sidebar-mobile-toggler">
						<button type="button" class="btn" aria-label="Folder" on:click={toggleMobileSidebar}><i class="far fa-lg fa-folder"></i></button>
					</div>
				...
				<div class="file-manager-content d-flex flex-column">
					<div class="mb-0 d-flex text-nowrap p-3 flex-wrap gap-2 border-bottom">
						<button type="button" class="btn btn-sm btn-white px-2" aria-label="Home"><i class="fa fa-fw fa-home"></i></button>
						...
						<button type="button" class="btn btn-sm btn-white px-2" aria-label="Folder"><i class="fa fa-fw fa-arrows-rotate"></i></button>
