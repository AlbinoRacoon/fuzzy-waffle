...
<div class="row gx-4">
	<div class="col-lg-8">
		<Card class="border-0 mb-4">
			<CardHeader class="h6 mb-0 bg-none p-3">
			...
			<CardBody>
				...
				<div class="">
					...
					<div class="form-control p-0">
						<div class="border-0"><quill-editor theme="snow" class="h-250px"></quill-editor></div>
					</div>
				</div>
			</CardBody>
		</Card>
		...
		<Card class="border-0 mb-4">
			...
			<CardBody>
				...
				<div class="row mb-3 gx-3">
					...
					<div class="col-7">
						<Tags bind:tags={tagsSize} />
					</div>
					<div class="col-1">
						<a href="#/" class="btn btn-default d-block" aria-label="Remove"><i class="fa fa-trash"></i></a>
					</div>
				</div>
				<div class="row mb-3 gx-3">
					<div class="col-4"><input type="text" class="form-control" name="variant[1][name]" placeholder="e.g Color" value="Color" /></div>
					<div class="col-7">
						<Tags bind:tags={tagsColor} />
					</div>
					<div class="col-1">
						<a href="#/" class="btn btn-default d-block" aria-label="Remove"><i class="fa fa-trash"></i></a>
					</div>
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="mb-lg-0 mb-3">
							<label class="form-label" for="">Warranty Type</label>
					...
					<div class="col-lg-6">
						<div class="mb-lg-0 mb-3">
							<label class="form-label" for="">Warranty Period</label>
		...
		<Card class="border-0 mb-4">
			...
			<CardBody>
				<div class="mb-3">
					<label class="form-label" for="">What's in the box</label>
				...
				<div class="row mb-n3">
					...
					<div class="col-lg-6">
						<div class="form-group">
							<label class="form-label" for="">Parcel Size</label>
							<div class="row">
								<div class="col-4">
			...
			<CardBody class="bg-light rounded-bottom">
		...
		<Card class="border-0 mb-4">
			...
			<CardBody class="fw-bold">
				<div class="d-flex">
					...
					<div class="w-50px text-center"><a href="#/" aria-label="Calendar" class="text-decoration-none"><i class="fa fa-lg fa-fw fa-calendar"></i></a></div>
				</div>
				<hr />
				<div class="d-flex">
					<div class="flex-1 d-flex">
				...
				<div class="d-flex">
					...
					<div class="w-50px text-center"><a href="#/" aria-label="Remove" class="text-decoration-none text-gray-500"><i class="fa fa-lg fa-fw fa-times"></i></a></div>
				</div>
			</CardBody>
		</Card>
		<Card class="border-0 mb-4">
			...
			<CardBody class="fw-bold">
				<div class="mb-3">
					...
					<div class="input-group">
						...
						<button class="btn btn-white" aria-label="Search"><i class="fa fa-search"></i></button>
					</div>
				</div>
				<div class="mb-0">
