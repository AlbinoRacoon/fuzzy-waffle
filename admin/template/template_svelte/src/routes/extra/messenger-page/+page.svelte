...
<div class="messenger">
	<div class="messenger-menu">
		<div class="messenger-menu-item my-2">
			<a href="#/" class="messenger-menu-link">
				<div class="m-n1">
					<img alt="" src="/img/user/user-13.jpg" class="w-100 d-block rounded-circle" />
				</div>
			</a>
		</div>
		<div class="messenger-menu-item active">
			<a href="#/" class="messenger-menu-link">
				<Icon class="fs-30px" icon="solar:dialog-2-bold-duotone" />
			</a>
		</div>
		<div class="messenger-menu-item">
			<a href="#/" class="messenger-menu-link">
				<Icon class="fs-30px" icon="solar:notebook-bold-duotone" />
			</a>
		</div>
		<div class="messenger-menu-item">
			<a href="#/" class="messenger-menu-link">
				<Icon class="fs-30px" icon="solar:box-minimalistic-bold-duotone" />
			</a>
		</div>
		<div class="messenger-menu-item">
			<a href="#/" class="messenger-menu-link">
				<Icon class="fs-30px" icon="solar:folder-with-files-bold-duotone" />
			</a>
		</div>
		<div class="messenger-menu-item">
			<a href="#/" class="messenger-menu-link">
				<Icon class="fs-30px" icon="solar:clapperboard-play-bold-duotone" />
			</a>
		</div>
		<div class="messenger-menu-item">
			<a href="#/" class="messenger-menu-link">
				<Icon class="fs-30px" icon="solar:settings-bold-duotone" />
			</a>
		</div>
	</div>
	<div class="messenger-chat">
		<div class="messenger-chat-header d-flex">
			...
			<div class="ps-2">
				<a href="#/" aria-label="Link" class="btn border-0 bg-light shadow-none">
			...
			<PerfectScrollbar class="h-100">
				<div class="messenger-chat-list">
					<div class="messenger-chat-item">
						<a href="#/" class="messenger-chat-link" data-toggle-class="messenger-chat-content-mobile-toggled" data-target="#messenger">
					...
					<div class="messenger-chat-item active">
						<a href="#/" class="messenger-chat-link" data-toggle-class="messenger-chat-content-mobile-toggled" data-target="#messenger">
							<div class="messenger-chat-media flex-wrap overflow-hidden">
								<img alt="" src="/img/user/user-1.jpg" width="14" class="rounded-0 me-1px mb-1px" />
								<img alt="" src="/img/user/user-2.jpg" width="14" class="rounded-0 me-1px mb-1px" />
								<img alt="" src="/img/user/user-3.jpg" width="14" class="rounded-0 me-0px mb-1px" />
								<img alt="" src="/img/user/user-4.jpg" width="14" class="rounded-0 me-1px mb-1px" />
								<img alt="" src="/img/user/user-5.jpg" width="14" class="rounded-0 me-1px mb-1px" />
								<img alt="" src="/img/user/user-6.jpg" width="14" class="rounded-0 me-0px mb-1px" />
								<img alt="" src="/img/user/user-7.jpg" width="14" class="rounded-0 me-1px mb-1px" />
								<img alt="" src="/img/user/user-8.jpg" width="14" class="rounded-0 me-1px mb-1px" />
								<img alt="" src="/img/user/user-9.jpg" width="14" class="rounded-0 me-0px mb-1px" />
							</div>
							<div class="messenger-chat-content">
								<div class="messenger-chat-title">
					...
					<div class="messenger-chat-item">
						<a href="#/" class="messenger-chat-link" data-toggle-class="messenger-chat-content-mobile-toggled" data-target="#messenger">
							<div class="messenger-chat-media bg-orange text-orange-900">
								<Icon icon="solar:oven-mitts-bold-duotone" />
							</div>
							<div class="messenger-chat-content">
								<div class="messenger-chat-title">
					...
					<div class="messenger-chat-item">
						<a href="#/" class="messenger-chat-link" data-toggle-class="messenger-chat-content-mobile-toggled" data-target="#messenger">
							<div class="messenger-chat-media bg-blue-900 text-blue">
								<Icon icon="solar:gamepad-charge-bold-duotone" />
							</div>
							<div class="messenger-chat-content">
								<div class="messenger-chat-title">
									<div>Gaming Crew</div>
						...
						<a href="#/" class="messenger-chat-link" data-toggle-class="messenger-chat-content-mobile-toggled" data-target="#messenger">
							<div class="messenger-chat-media row gx-0 overflow-hidden">
								<div class="col-6 d-flex flex-column">
									<img alt="" src="/img/user/user-10.jpg" class="w-100 rounded-0" />
									<img alt="" src="/img/user/user-11.jpg" class="w-100 rounded-0" />
								</div>
								<div class="col-6 d-flex flex-column">
									<img alt="" src="/img/user/user-12.jpg" class="w-100 rounded-0" />
									<img alt="" src="/img/user/user-13.jpg" class="w-100 rounded-0" />
								</div>
							</div>
							<div class="messenger-chat-content">
								<div class="messenger-chat-title">
					...
					<div class="messenger-chat-item">
						<a href="#/" class="messenger-chat-link" data-toggle-class="messenger-chat-content-mobile-toggled" data-target="#messenger">
							<div class="messenger-chat-media">
								<Icon class="text-red-600" icon="solar:calendar-bold-duotone" />
							</div>
							<div class="messenger-chat-content">
								<div class="messenger-chat-title">
					...
					<div class="messenger-chat-item">
						<a href="#/" class="messenger-chat-link" data-toggle-class="messenger-chat-content-mobile-toggled" data-target="#messenger">
							<div class="messenger-chat-media">
								<Icon icon="solar:bicycling-bold-duotone" />
							</div>
							<div class="messenger-chat-content">
								<div class="messenger-chat-title">
		...
		<div class="widget-chat">
			<div class="widget-chat-header">
				<div class="d-block d-lg-none">
					<button type="button" aria-label="Button" class="btn border-0 shadow-none" data-toggle-class="messenger-chat-content-mobile-toggled" data-target="#messenger">
				...
				<div class="">
					<button type="button" aria-label="Button" class="btn border-0 shadow-none" data-bs-toggle="dropdown">
				...
				<div class="widget-chat-body">
					<div class="widget-chat-item with-media end">
						<div class="widget-chat-media">
							<img alt="" src="/img/user/user-13.jpg" />
						</div>
					...
					<div class="widget-chat-item with-media start">
						<div class="widget-chat-media">
							<img alt="" src="/img/user/user-4.jpg" />
						</div>
						<div class="widget-chat-info">
							<div class="widget-chat-info-container">
								<div class="widget-chat-name text-blue">Daniel</div>
			...
			<div class="widget-chat-input">
				<div class="widget-chat-toolbar">
					<a href="#/" class="widget-chat-toolbar-link" id="trigger">
						<Icon class="fs-26px" icon="solar:smile-circle-outline" />
					</a>
					<a href="#/" class="widget-chat-toolbar-link">
						<Icon class="fs-26px" icon="solar:folder-with-files-outline" />
					</a>
					<a href="#/" class="widget-chat-toolbar-link">
						<Icon class="fs-26px" icon="solar:scissors-square-outline" />
					</a>
					<a href="#/" class="widget-chat-toolbar-link">
						<Icon class="fs-26px" icon="solar:chat-round-dots-outline" />
					</a>
					<a href="#/" class="widget-chat-toolbar-link ms-auto">
						<Icon class="fs-26px" icon="solar:phone-calling-outline" />
					</a>
					<a href="#/" class="widget-chat-toolbar-link">
						<Icon class="fs-26px" icon="solar:videocamera-record-outline" />
					</a>
				</div>
				<textarea class="form-control fs-16px" id="input"></textarea>
			</div>
		</div>
	</div>
</div>