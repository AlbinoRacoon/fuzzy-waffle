...
<div id="header" class="app-header navbar navbar-expand-lg p-0">
	<div class="container-xxl px-3 px-lg-5 d-flex align-items-center flex-1">
		<button type="button" class="navbar-mobile-toggler px-0 me-3" aria-label="Mobile Toggler" data-bs-toggle="collapse" data-bs-target="#navbarContent">
...
<div id="home" class="py-5 position-relative bg-black bg-size-cover" data-bs-theme="dark">
					...
					<div class="row text-body mt-4 mb-4">
						...
						<div class="col-6 mb-3 mb-lg-0">
							<div class="d-flex align-items-center">
								<div class="h1 text-body text-opacity-25 me-3"><Icon icon="bi:download"></Icon></div>
								<div>
						...
						<div class="col-6">
							<div class="d-flex align-items-center">
								<div class="h1 text-body text-opacity-25 me-3"><Icon icon="bi:bootstrap"></Icon></div>
								<div>
	...
	<div class="position-absolute top-0 bottom-0 end-0 w-50 p-5 overflow-hidden d-none d-lg-flex align-items-center z-2">
		<img class="w-100 d-block position-relative" alt="Color Admin" src="/img/landing/mockup-1-default.jpg" />
	</div>
	<div class="position-absolute bg-size-cover bg-position-center bg-no-repeat top-0 start-0 w-100 h-100" style="background-image: url(/img/coming-soon/coming-soon.jpg);"></div>
		...
		<div class="row text-start g-3 gx-lg-5 gy-lg-4">
			<div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
				<div class="w-50px h-50px rounded-3 bg-primary bg-opacity-15 text-primary fs-32px d-flex align-items-center justify-content-center">
					<Icon icon="solar:monitor-smartphone-bold-duotone"></Icon>
				</div>
			...
			<div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
				<div class="w-50px h-50px rounded-3 bg-warning bg-opacity-15 text-warning fs-32px d-flex align-items-center justify-content-center">
					<Icon icon="solar:bolt-bold-duotone"></Icon>
				</div>
				<div class="flex-1 ps-3">
			...
			<div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
				<div class="w-50px h-50px rounded-3 bg-info bg-opacity-15 text-info fs-32px d-flex align-items-center justify-content-center">
					<Icon icon="solar:lock-keyhole-bold-duotone"></Icon>
				</div>
				<div class="flex-1 ps-3">
					<h4>Secure</h4>
			...
			<div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
				<div class="w-50px h-50px rounded-3 bg-green bg-opacity-15 text-green fs-32px d-flex align-items-center justify-content-center">
					<Icon icon="solar:dialog-2-bold-duotone"></Icon>
				</div>
				<div class="flex-1 ps-3">
			...
			<div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
				<div class="w-50px h-50px rounded-3 bg-red bg-opacity-15 text-red fs-32px d-flex align-items-center justify-content-center">
					<Icon icon="solar:help-bold-duotone"></Icon>
				</div>
				<div class="flex-1 ps-3">
					<h4>24/7 Support</h4>
			...
			<div class="col-xl-3 col-lg-4 col-sm-6 d-flex">
				<div class="w-50px h-50px rounded-3 bg-pink bg-opacity-15 text-pink fs-32px d-flex align-items-center justify-content-center">
					<Icon icon="solar:tuning-bold-duotone"></Icon>
				</div>
				<div class="flex-1 ps-3">
	...
	<div class="container-xxl p-3 p-lg-5 z-2 position-relative">
		...
		<div class="row g-3 g-lg-5">
			<div class="col-xl-3 col-lg-4 col-sm-6">
				<a href="/img/landing/mockup-1-default.jpg" data-lity data-sveltekit-reload class="shadow d-block"><img src="/img/landing/mockup-1-default-thumb.jpg" alt="" class="mw-100"></a>
				<div class="text-center my-3 text-body fw-bold">Theme Dashboard</div>
			</div>
			<div class="col-xl-3 col-lg-4 col-sm-6">
				<a href="/img/landing/mockup-2-default.jpg" data-lity data-sveltekit-reload class="shadow d-block"><img src="/img/landing/mockup-2-default-thumb.jpg" alt="" class="mw-100"></a>
				<div class="text-center my-3 text-body fw-bold">POS System UI</div>
			</div>
			<div class="col-xl-3 col-lg-4 col-sm-6">
				<a href="/img/landing/mockup-3-default.jpg" data-lity data-sveltekit-reload class="shadow d-block"><img src="/img/landing/mockup-3-default-thumb.jpg" alt="" class="mw-100"></a>
				<div class="text-center my-3 text-body fw-bold">Color Admin Widgets</div>
			</div>
			<div class="col-xl-3 col-lg-4 col-sm-6">
				<a href="/img/landing/mockup-4-default.jpg" data-lity data-sveltekit-reload class="shadow d-block"><img src="/img/landing/mockup-4-default-thumb.jpg" alt="" class="mw-100"></a>
				<div class="text-center my-3 text-body fw-bold">Pricing Page</div>
			</div>
			<div class="col-xl-3 col-lg-4 col-sm-6">
				<a href="/img/landing/mockup-5-default.jpg" data-lity data-sveltekit-reload class="shadow d-block"><img src="/img/landing/mockup-5-default-thumb.jpg" alt="" class="mw-100"></a>
				<div class="text-center my-3 text-body fw-bold">Settings Page</div>
			</div>
			<div class="col-xl-3 col-lg-4 col-sm-6">
				<a href="/img/landing/mockup-6-default.jpg" data-lity data-sveltekit-reload class="shadow d-block"><img src="/img/landing/mockup-6-default-thumb.jpg" alt="" class="mw-100"></a>
				<div class="text-center my-3 text-body fw-bold">Data Management</div>
			</div>
			<div class="col-xl-3 col-lg-4 col-sm-6">
				<a href="/img/landing/mockup-7-default.jpg" data-lity data-sveltekit-reload class="shadow d-block"><img src="/img/landing/mockup-7-default-thumb.jpg" alt="" class="mw-100"></a>
				<div class="text-center my-3 text-body fw-bold">User Profile</div>
			</div>
			<div class="col-xl-3 col-lg-4 col-sm-6">
				<a href="/img/landing/frontend-one-page-parallax.jpg" data-lity data-sveltekit-reload class="shadow d-block"><img src="/img/landing/frontend-one-page-parallax-thumb.jpg" alt="" class="mw-100"></a>
				<div class="text-center my-3 text-body fw-bold">Frontend - One Page Parallax</div>
			</div>
			<div class="col-xl-3 col-lg-4 col-sm-6">
				<a href="/img/landing/frontend-e-commerce.jpg" data-lity data-sveltekit-reload class="shadow d-block"><img src="/img/landing/frontend-e-commerce-thumb.jpg" alt="" class="mw-100"></a>
				<div class="text-center my-3 text-body fw-bold">Frontend - E-Commerce</div>
			</div>
			<div class="col-xl-3 col-lg-4 col-sm-6">
				<a href="/img/landing/frontend-blog.jpg" data-lity data-sveltekit-reload class="shadow d-block"><img src="/img/landing/frontend-blog-thumb.jpg" alt="" class="mw-100"></a>
				<div class="text-center my-3 text-body fw-bold">Frontend - Blog</div>
			</div>
			<div class="col-xl-3 col-lg-4 col-sm-6">
				<a href="/img/landing/frontend-forum.jpg" data-lity data-sveltekit-reload class="shadow d-block"><img src="/img/landing/frontend-forum-thumb.jpg" alt="" class="mw-100"></a>
				<div class="text-center my-3 text-body fw-bold">Frontend - Forum</div>
			</div>
			<div class="col-xl-3 col-lg-4 col-sm-6">
				<a href="/img/landing/frontend-corporate.jpg" data-lity data-sveltekit-reload class="shadow d-block"><img src="/img/landing/frontend-corporate-thumb.jpg" alt="" class="mw-100"></a>
				<div class="text-center my-3 text-body fw-bold">Frontend - Corporate</div>
			</div>
		</div>
	</div>
	<div class="position-absolute bg-size-cover bg-position-center bg-no-repeat top-0 start-0 w-100 h-100" style="background-image: url(/img/gallery/gallery-1.jpg);"></div>
				...
				<div class="card border-0 rounded-4 h-100 bg-gray-900">
					<div class="card-body fs-14px p-30px d-flex flex-column">
						<div class="d-flex align-items-center">
							...
							<div>
								<Icon icon="solar:usb-bold-duotone" class="display-4 text-gray-400 rounded-3"></Icon>
							</div>
						</div>
						<hr class="my-4">
				...
				<div class="card border-0 rounded-4 h-100 bg-gray-900">
					<div class="card-body fs-14px p-30px d-flex flex-column">
						<div class="d-flex align-items-center">
							...
							<div>
								<Icon icon="solar:map-arrow-up-bold-duotone" class="display-4 text-gray-400 rounded-3"></Icon>
							</div>
						</div>
						<hr class="my-4">
						<div class="mb-5 text-body flex-1">
				...
				<div class="card border-0 rounded-4 shadow-lg bg-gradient-cyan-blue text-white h-100">
					<div class="card-body fs-15px p-30px h-100 d-flex flex-column">
						<div class="d-flex align-items-center">
							...
							<div>
								<Icon icon="solar:cup-first-bold-duotone" class="display-3 text-black text-opacity-50 rounded-3"></Icon>
							</div>
						</div>
				...
				<div class="card border-0 rounded-4 h-100 bg-gray-900">
					<div class="card-body fs-14px p-30px d-flex flex-column">
						<div class="d-flex align-items-center">
							...
							<div>
								<Icon icon="solar:buildings-bold-duotone" class="display-4 text-gray-400 rounded-3"></Icon>
							</div>
						</div>
						<hr class="my-4">
						<div class="mb-5 text-white text-opacity-75 flex-1">
	...
	<div class="container-xxl p-3 p-lg-5">
		...
		<div class="row g-3 g-lg-4 mb-4">
			<div class="col-xl-4 col-md-6">
				<div class="card p-4 border-0 h-100 rounded-5">
					<div class="d-flex align-items-center mb-3">
						<img src="/img/user/user-1.jpg" class="rounded-circle me-3 w-50px" alt="Client 1">
						<div>
					...
					<div class="mb-4 d-flex">
						...
						<div class="p-3 fs-5">
							<div class="text-warning d-flex mb-2">
								<Icon icon="ic:baseline-star" class="fs-18px"></Icon>
								<Icon icon="ic:baseline-star" class="fs-18px"></Icon>
								<Icon icon="ic:baseline-star" class="fs-18px"></Icon>
								<Icon icon="ic:baseline-star" class="fs-18px"></Icon>
								<Icon icon="ic:baseline-star" class="fs-18px"></Icon>
			...
			<div class="col-xl-4 col-md-6">
				<div class="card p-4 border-0 h-100 rounded-5">
					<div class="d-flex align-items-center mb-3">
						<img src="/img/user/user-3.jpg" class="rounded-circle me-3 w-50px" alt="Client 1">
						<div>
			...
			<div class="col-xl-4 col-md-6">
				<div class="card p-4 border-0 h-100 rounded-5">
					<div class="d-flex align-items-center mb-3">
						<img src="/img/user/user-13.jpg" class="rounded-circle me-3 w-50px" alt="Client 1">
						<div>
			...
			<div class="col-xl-4 col-md-6">
				<div class="card p-4 border-0 h-100 rounded-5">
					<div class="d-flex align-items-center mb-3">
						<img src="/img/user/user-8.jpg" class="rounded-circle me-3 w-50px" alt="Client 1">
						<div>
			...
			<div class="col-xl-4 col-md-6">
				<div class="card p-4 border-0 h-100 rounded-5">
					<div class="d-flex align-items-center mb-3">
						<img src="/img/user/user-5.jpg" class="rounded-circle me-3 w-50px" alt="Client 1">
						<div>
							<h5 class="mb-0">John Doe</h5>
							<small class="text-muted">CEO, Company</small>
						</div>
		...
		<div class="row g-3 g-xl-4 mb-5">
			<div class="col-xl-3 col-lg-4 col-sm-6">
				<div class="d-flex flex-column h-100 rounded-4 overflow-hidden shadow-lg mb-5 mb-lg-0">
					<div>
						<img src="/img/landing/blog-1.jpg" alt="" class="object-fit-cover h-200px w-100 d-block">
					</div>
			...
			<div class="col-xl-3 col-lg-4 col-sm-6">
				<div class="d-flex flex-column h-100 rounded-4 overflow-hidden shadow-lg mb-5 mb-lg-0">
					<div>
						<img src="/img/landing/blog-2.jpg" alt="" class="object-fit-cover h-200px w-100 d-block">
					</div>
					<div class="flex-1 p-3 pb-0">
						<div class="mb-2">
			...
			<div class="col-xl-3 col-lg-4 col-sm-6">
				<div class="d-flex flex-column h-100 rounded-4 overflow-hidden shadow-lg mb-5 mb-lg-0">
					<div>
						<img src="/img/landing/blog-3.jpg" alt="" class="object-fit-cover h-200px w-100 d-block">
					</div>
					<div class="flex-1 p-3 pb-0">
						<div class="mb-2">
			...
			<div class="col-xl-3 col-lg-4 col-sm-6">
				<div class="d-flex flex-column h-100 rounded-4 overflow-hidden shadow-lg mb-5 mb-lg-0">
					<div>
						<img src="/img/landing/blog-4.jpg" alt="" class="object-fit-cover h-200px w-100 d-block">
					</div>
					<div class="flex-1 p-3 pb-0">
						<div class="mb-2">
			...
			<div class="col-lg-6">
				<form action="/" method="GET" name="form_contact_us">
					<div class="row gy-3 mb-3">
						<div class="col-6">
							<label class="form-label" for="">First Name <span class="text-theme">*</span></label>
							<input type="text" class="form-control form-control-lg fs-15px">
						</div>
						<div class="col-6">
							<label class="form-label" for="">Last Name <span class="text-theme">*</span></label>
							<input type="text" class="form-control form-control-lg fs-15px">
						</div>
						<div class="col-6">
							<label class="form-label" for="">Email <span class="text-theme">*</span></label>
							<input type="text" class="form-control form-control-lg fs-15px">
						</div>
						<div class="col-6">
							<label class="form-label" for="">Phone <span class="text-theme">*</span></label>
							<input type="text" class="form-control form-control-lg fs-15px">
						</div>
						<div class="col-12">
							<label class="form-label" for="">Message <span class="text-theme">*</span></label>
	...
	<div class="container-xxl px-3 px-lg-5">
		<div class="row gx-lg-5 gx-3 gy-lg-4 gy-3">
			<div class="col-lg-3 col-md-6">
				...
				<h5>Follow Us</h5>
				<div class="d-flex">
					<a href="#/" aria-label="Example" class="me-2 text-body text-opacity-50"><i class="fab fa-lg fa-facebook fa-fw"></i></a>
					<a href="#/" aria-label="Example" class="me-2 text-body text-opacity-50"><i class="fab fa-lg fa-instagram fa-fw"></i></a>
					<a href="#/" aria-label="Example" class="me-2 text-body text-opacity-50"><i class="fab fa-lg fa-twitter fa-fw"></i></a>
					<a href="#/" aria-label="Example" class="me-2 text-body text-opacity-50"><i class="fab fa-lg fa-youtube fa-fw"></i></a>
					<a href="#/" aria-label="Example" class="me-2 text-body text-opacity-50"><i class="fab fa-lg fa-linkedin fa-fw"></i></a>
				</div>
			</div>
			<div class="col-lg-3 col-md-6">
				<h5>Quick Links</h5>
