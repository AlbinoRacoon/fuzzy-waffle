<script>
  ...
  onMount(async () => {
    setPageTitle('Tabs & Accordions');
		...
		for (var i = 1; i < 6; i++) {
			let response = await fetch('/data/ui/tabs-accordions-code-'+ i +'.json');
			...
			<div class="row">
				...
				<div class="col-xl-3">
					...
					<nav id="sidebar-bootstrap" class="navbar navbar-sticky d-none d-xl-block">
						<nav class="nav">
							<NavScrollTo target="#tabs">Tabs</NavScrollTo>
							<NavScrollTo target="#tabsV2">Tabs v2</NavScrollTo>
							<NavScrollTo target="#tabsWithCard">Tabs with card</NavScrollTo>
							<NavScrollTo target="#pills">Pills</NavScrollTo>
							<NavScrollTo target="#accordion">Accordion</NavScrollTo>
						</nav>
					</nav>
