...
{ url: '/bootstrap-5', img: '/img/logo/logo-bs5.png', title: 'Bootstrap 5', label: 'NEW' },
...
{ url: '/landing', icon: 'fa fa-crown', title: 'Landing Page' },
{ url: '/calendar', icon: 'fa fa-calendar', title: 'Calendar' },
{ url: '/map', icon: 'fa fa-map', title: 'Map',
	children: [
		{ url: '/map/vector', title: 'Vector Map' },
		{ url: '/map/google', title: 'Google Map' }
	]
},
{ url: '/gallery', icon: 'fa fa-image', title: 'Gallery',
	children: [
		{ url: '/gallery/v1', title: 'Gallery v1' },
		{ url: '/gallery/v2', title: 'Gallery v2' }
	]
},
